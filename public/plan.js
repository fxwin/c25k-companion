...
(function () {
  ...
  // totalMinutes excludes warmup. Completes the full segment even if it slightly exceeds target time.
  ...
  window.C25K.PLAN = [
    ...
    // Week 2 (day 3 target: 25 min alternations after warmup; may run longer to finish a segment)
